...
export default function FreelancersPage() {
  ...
  const {
  ...
  } = useGetFreelancersQuery(
    {
      ...
      filters: {
        ...
        experienceLevel:
          selectedExperience === "All Levels" ? undefined : selectedExperience,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center md:text-left md:max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
              Find Top Freelancers For Your Project
            </h1>
            <p className="text-xl text-blue-100 mb-8">
              Hire verified professionals with proven expertise
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 -mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-emerald-500 transform hover:-translate-y-1 transition-all">
            <div className="text-2xl font-bold text-gray-900 mb-1">95%</div>
            <div className="text-sm text-gray-600">Client Satisfaction</div>
          </div>
          <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-cyan-500 transform hover:-translate-y-1 transition-all">
            <div className="text-2xl font-bold text-gray-900 mb-1">24/7</div>
            <div className="text-sm text-gray-600">Customer Support</div>
          </div>
          <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-amber-500 transform hover:-translate-y-1 transition-all">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                  <div className="flex items-center">
                    ...
                    >
                      <path
                        d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13.41 18.09V20H10.74V18.07C9.03 17.71 7.58 16.61 7.47 14.67H9.43C9.53 15.72 10.25 16.54 12.08 16.54C14.04 16.54 14.48 15.56 14.48 14.95C14.48 14.12 14.04 13.34 11.81 12.81C9.33 12.21 7.63 11.19 7.63 9.14C7.63 7.42 9.02 6.3 10.74 5.93V4H13.41V5.95C15.27 6.4 16.2 7.81 16.26 9.34H14.3C14.25 8.23 13.66 7.47 12.08 7.47C10.58 7.47 9.68 8.15 9.68 9.11C9.68 9.95 10.33 10.5 12.35 11.02C14.37 11.54 16.53 12.41 16.53 14.93C16.53 16.75 15.15 17.76 13.41 18.09Z"
                        fill="currentColor"
                      />
                    </svg>
                    Hourly Rate:{" "}
        ...
        {isLoading && (
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-500 mt-2">
              Please wait while we find the perfect match for your project
            </p>
          </div>
        )}
        ...
        {isError && (
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-md border border-red-100 overflow-hidden">
            ...
            <p className="text-gray-600 mb-6 max-w-md text-center">
              {error
                ? "There was an error loading freelancer data."
                : "We couldn't load the freelancer data at this time. Please try again later."}
            </p>
            <Button
              onClick={() => refetch()}
              className="bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 hover:from-blue-700 hover:via-cyan-700 hover:to-emerald-700 text-white px-8 py-2 rounded-full shadow-md"
            >
              Retry Now
            </Button>
          </div>
        ...
        {!isLoading && !isError && freelancers.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 mb-6 max-w-md text-center">
              We couldn't find any freelancers matching your current filters.
              Try adjusting your search criteria to discover our talented
              professionals.
            </p>
            <Button
              onClick={() => {
              ...
              >
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 md:grid-cols-5 w-full">
                    ...
                    <div className="md:col-span-1 relative bg-gradient-to-b from-blue-50 to-emerald-50 p-6 flex flex-col items-center justify-center border-r border-gray-100">
                      <div className="absolute top-0 left-0 w-full h-12 bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 opacity-80 group-hover:opacity-100 transition-opacity"></div>

                      <div className="relative mb-4 group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-emerald-500 rounded-full opacity-75 group-hover:opacity-100 blur-sm group-hover:blur transition-all duration-300"></div>
                        <div className="relative">
                          <Image
                      ...
                      <div className="flex flex-col items-center text-center">
                        ...
                        <div className="flex items-center mb-3">
                          ...
                          <span className="font-medium text-gray-900">
                            {freelancer.stats?.averageRating?.toFixed(1) ||
                              "New"}
                          </span>
                        ...
                        <div className="flex items-center text-sm text-gray-600">
                          <div
                            className={`w-2 h-2 rounded-full mr-1 ${
                              getFreelancerAvailability(freelancer) ===
                              "available"
                                ? "bg-green-500"
                                : "bg-yellow-500"
                            }`}
                      ...
                      <div className="flex flex-col h-full">
                        <div className="mb-4 flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            className="rounded-full h-9 w-9 p-0 border-gray-300 hover:bg-pink-50 hover:border-pink-300 hover:text-pink-600 transition-colors"
                          >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                          <div className="flex flex-col bg-blue-50 p-3 rounded-lg border border-blue-100 hover:shadow-md transition-shadow">
                            <span className="text-sm text-blue-700 font-medium mb-1">
                              Experience
                            </span>
                            <div className="flex items-center">
                          ...
                          <div className="flex flex-col bg-green-50 p-3 rounded-lg border border-green-100 hover:shadow-md transition-shadow">
                            <span className="text-sm text-green-700 font-medium mb-1">
                              Response Time
                            </span>
                            <div className="flex items-center">
                          ...
                          <div className="flex flex-col bg-cyan-50 p-3 rounded-lg border border-cyan-100 hover:shadow-md transition-shadow">
                            <span className="text-sm text-cyan-700 font-medium mb-1">
                              Member Since
                            </span>
                            <div className="flex items-center">
                              <div className="p-1.5 rounded-md bg-cyan-600 text-white mr-3">
                              ...
                              <span className="font-medium text-gray-800">
                                {typeof freelancer.createdAt === "string"
                                  ...
                                  : freelancer.createdAt &&
                                    freelancer.createdAt.seconds
                                  ? new Date(
                                      freelancer.createdAt.seconds * 1000
                                    ).getFullYear()
                                  : "New"}
                              </span>
                            </div>
                        ...
                        <div className="flex-grow">
                          <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 mb-4">
                            <p className="text-gray-700 line-clamp-3 italic">
                              "{freelancer.overview || "No overview provided"}"
                            </p>
                          </div>
                          ...
                          <div className="mb-4">
                            <h4 className="text-sm font-semibold text-gray-700 mb-2 flex items-center">
                              ...
                              >
                                <path
                                  d="M2 6.5C2 4.01472 4.01472 2 6.5 2H17.5C19.9853 2 22 4.01472 22 6.5V17.5C22 19.9853 19.9853 22 17.5 22H6.5C4.01472 22 2 19.9853 2 17.5V6.5Z"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
                        ...
                        <div className="flex justify-between items-center pt-5 border-t border-gray-100">
                          ...
                          <div className="flex space-x-3">
                            ...
                            <Link href={`/profile/${freelancer.userId}`}>
                              <Button
                                size="sm"
                                className="bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 hover:from-blue-700 hover:via-cyan-700 hover:to-emerald-700 text-white rounded-full shadow-md hover:shadow-lg transition-shadow px-5"
                              >
                                View Profile
                              </Button>
                            </Link>
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 rounded-2xl overflow-hidden shadow-xl">
          <div className="p-8 md:p-12 flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-blue-100 text-lg mb-6">
                Post your project today and get proposals from our verified
                freelancers within hours.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <Button
                  variant="outline"
                  className="bg-transparent border-2 border-white text-white hover:bg-white/10 rounded-full px-8 py-6 text-lg font-medium"
                >
      ...
      <div className="bg-gray-900 mt-16 py-12 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h3 className="text-2xl font-bold text-white mb-4">
            Join thousands of businesses hiring on Bizzlink
          </h3>
          <p className="text-gray-400 mb-6">
            Find the perfect match for your next project with our pool of
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Button
              variant="outline"
              className="border-white text-white hover:bg-gray-800 rounded-full px-6"
            >
              Learn More
            </Button>
          </div>
